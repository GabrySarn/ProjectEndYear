            ...
            <form action="product.php" method="post" id="productForm">
                <div class="modal-body">
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input type="text" class="form-control" name="descriz" aria-label="Sizing example input"
                            aria-describedby="inputGroup-sizing-default">
                    </div>
                </div>
                <div class="modal-footer">
                    <button name="add" type="submit" class="btn bg-custom">Add</button>
                </div>
            </form>
        </div>
    </div>
...
<div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasNavbar" aria-labelledby="offcanvasNavbarLabel">
    ...
    <div class="offcanvas-body">
        ...
        <div class="d-grid gap-2">
            <button class="btn bg-custom" type="button" onclick="convertCurrency()">Send</button>
        </div>
