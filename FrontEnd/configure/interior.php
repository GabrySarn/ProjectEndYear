            ...
            <div class="interior-selector">
              <form method="POST" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
                <label>
                  ...
                  <img src="images/Interiors/normal_seats.png" alt="Wheel 1" style="width: 100px; height: 130px;">Basic
                  Seats</label>

                <label>
                  <input type="radio" name="interior" class="interior-option" value="sport_interior">
                  <img src="images/Interiors/sport_seats.png" alt="Wheel 2" style="width: 100px; height: 130px;">Sport
                  Seats
                </label>
                <button type="submit" class="u-border-2 u-border-black u-btn u-button-style u-hover-black u-text-black u-text-hover-white u-btn-1">ADD
                  NOW</button>
              </form>
            </div>
          </div>
